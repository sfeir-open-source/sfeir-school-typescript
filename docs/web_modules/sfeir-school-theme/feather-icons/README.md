...
- [API Reference](#api-reference)
  _ [`feather.icons`](#feathericons)
  _ [`feather.icons[name].toSvg()`](#feathericonsnametosvgattrs)
  _ [`feather.replace()`](#featherreplaceattrs)
  _ [(DEPRECATED) `feather.toSvg()`](#deprecated-feathertosvgname-attrs)
