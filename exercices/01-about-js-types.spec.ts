...
describe('about basic types', () => {
  it.skip('you should know the type of true/false', () => {
    var exp = true;
    expect(typeof exp).to.eq(__);
  });

  it.skip('you should know the type of some quoted characters', () => {
    var exp = 'SFEIR';
    expect(typeof exp).to.eq(__);
  });

  it.skip('you should know the type of logically combined expressions', () => {
    var exp1 = 42 === 42 && 2 < 1;
  ...
  it.skip('you should know the type of numeric expressions', () => {
    var exp1 = 42;
    var exp2 = 3.1415;
    expect(typeof exp1).to.eq(__);
    expect(typeof exp2).to.eq(__);
  ...
  it.skip('you should know the type of special numbers', () => {
    var notANumber = NaN;
  ...
  it.skip('you should know the type of something that is not (yet) anything', () => {
    var exp;
    expect(typeof exp).to.eq(__);
  });

  it.skip('you should know the type of functions', () => {
    function fun() {}
    var exp = () => {};
  ...
  it.skip('you should know the type of objects', () => {
    var exp = { foo: 'bar' };
    expect(typeof exp).to.eq(__);
  });

  it.skip('you should know the type of arrays', () => {
    var exp = [1, 2, 3];
    expect(typeof exp).to.eq(__);
    expect(getType(exp)).to.eq(__);
  });

  it.skip('you should know the type of some primitive instance', () => {
  ...
  it.skip('you should know the type of some native things', () => {
  ...
  it.skip('you should know the type of undefined !', () => {
    var exp = undefined;
    expect(typeof exp).to.eq(__);
    expect(getType(exp)).to.eq(__);
  });

  it.skip('you should know the type of null !', () => {
    var exp = null;
    expect(typeof exp).to.eq(__);
    expect(getType(exp)).to.eq(__);
  });
